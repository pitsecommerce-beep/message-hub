...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{ backgroundColor: 'var(--color-surface-0)' }}>
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        />
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-brand-600/15 rounded-full blur-[120px]" />
        <div className="absolute -bottom-40 -right-20 w-96 h-96 bg-violet-700/12 rounded-full blur-[100px]" />
      </div>

      <div className="w-full max-w-sm relative z-10">
        {/* Logo */}
        <div className="flex flex-col items-center gap-4 mb-8">
          <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-brand-400 to-brand-700 flex items-center justify-center shadow-2xl shadow-brand-900/60">
            <MessageSquare size={26} className="text-white" />
          </div>
          <div className="text-center">
            <h1 className="text-2xl font-bold text-white tracking-tight">MessageHub</h1>
            <p className="text-sm text-gray-600 mt-1">Plataforma de Mensajería Unificada</p>
          </div>
        </div>

        {/* Card */}
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-xl p-6 shadow-2xl shadow-black/50">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 text-gray-600" style={{ backgroundColor: 'rgb(9,9,15)' }}>
                o continúa con
              </span>
            </div>
          </div>
